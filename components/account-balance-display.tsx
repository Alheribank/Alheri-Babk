        ...
        <div className="bg-gray-900/60 border border-gray-800 rounded-lg p-4 backdrop-blur-md space-y-3 mb-4">
          <div className="flex items-center gap-2 pb-3 border-b border-gray-800">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm font-bold text-white break-words">OLAYIWOLA ALABI SEUN</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 pb-3 border-b border-gray-800">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm font-bold text-white font-mono">222599431</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm font-bold text-white">19/04/2026</p>
            </div>
          </div>
        </div>
